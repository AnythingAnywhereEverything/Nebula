...
const SellerProductComponent:React.FC<{props: ProductData, shop_id: string}> = ({
    props,
    shop_id
} : {props: ProductData, shop_id: string}) => {
        ...
        <Field orientation={'horizontal'} className={s.product}>
            <Field orientation={'horizontal'}>
                ...
                <ButtonGroup>
                    <ButtonGroup>
                        <Button asChild>
                            <Link href={`/portal/seller/${shop_id}/products/edit_product?id=${props.id}`}>
                                Edit
                            </Link>
                        </Button>
                    </ButtonGroup>
