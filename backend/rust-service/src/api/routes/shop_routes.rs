...
use crate::{
    api::{handlers::shop_handlers::{create_shop_handler, get_assosiate_shops_handler, get_current_shop_handler, get_shop_products, update_shop_banner_handler, update_shop_info_handler, update_shop_profile_handler}, middleware::user_mw}, application::state::SharedState
};
